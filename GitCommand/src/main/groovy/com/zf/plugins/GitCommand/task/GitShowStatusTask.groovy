...
import org.gradle.api.tasks.TaskAction
 ...
 class GitShowStatusTask extends DefaultTask {
    ...
    void action() {
     ...
     static class CreationAction implements Action<GitShowStatusTask> {
        ...
        @Override
        void execute(GitShowStatusTask task) {
            configWorkDir(task)
        }

        def configWorkDir(GitShowStatusTask task) {
