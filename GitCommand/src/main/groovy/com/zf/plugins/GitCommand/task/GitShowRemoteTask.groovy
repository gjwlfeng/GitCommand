...
import org.gradle.api.tasks.TaskAction
 ...
 class GitShowRemoteTask extends DefaultTask {
    ...
    void action() {
     ...
     static class CreationAction implements Action<GitShowRemoteTask> {
        ...
        @Override
        void execute(GitShowRemoteTask task) {

            configWorkDir(task)

        }

        def  configWorkDir(GitShowRemoteTask task) {
